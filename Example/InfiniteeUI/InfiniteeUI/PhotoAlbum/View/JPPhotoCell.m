...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        _noSelBorderWidth = JPSeparateLineThick + 0.01;
        _seledBorderWidth = 1.5;
        
        _noSelBorderColor = InfiniteeGrayA(0.3);
        _seledBorderColor = InfiniteeBlueA(1.0);
        ...
        UILabel *stateLabel = ({
            ...
            aLabel.font = [UIFont infiniteeFontWithSize:10];
...
- (void)layoutSubviews {
    ...
    self.stateView.layer.position = CGPointMake(self.jp_width, self.jp_height);
